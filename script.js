            ...
            for (const key1 in collectionOfProduct) {
              for (const key2 in productNameAndQuintity) {
                if (key1 == key2) {
                  ...
                  let prise =
                    collectionOfProduct[key1] * productNameAndQuintity[key2];
